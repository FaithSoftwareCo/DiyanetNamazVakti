...
(function mainWrapper() {
    ...
    function initBayramMenu(contentLoaded, bayramlar) {
        ...
        if (contentLoaded == false) {
            ...
            if (tizen.preference.exists('pref_ilid')) {
    ...
    function prepareMainUI() {
        ...
        {
            /*setTimeout(function() {
                showAlert(MY_LOCALE('select_loc_alert'));
            }, 100);*/
            ShowVakitler(false, null);
        } 
    ...
    function ShowVakitler(dbOK, vakitler) {
